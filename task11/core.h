...
struct so_pcb {
	...
	enum so_prio prio;         /**< Priority of the process */
};
...
/**
 * @brief   Enqueues the given process to the ready queue
 * @param   process Process to enqueue
 */
void sched_enqueue_blocked(struct so_pcb *process);

/**
 * @brief   Enqueues the given process to the I/O queue
 * @param   process Process to enqueue
 */
void sched_enqueue_io(struct so_pcb *process);

/**
 * @brief   Enqueues the given process to the blocked queue
 * @param   process Process to enqueue
 */
...
/**
 * @brief   Protects a critical core by locking a mutex and disabling signals
 */
void so_lock(void);

/**
 * @brief   To be called when critical core is left
 */
void so_unlock(void);
#endif /* CORE_H */
